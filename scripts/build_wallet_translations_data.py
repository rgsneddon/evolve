...
PROVIDER: dict[str, dict[str, str]] = {
    ...
    "de": {
        **provider_base(),
        ...
        "wallet_inbound_revert_days": "7 Tage",
        "wallet_inbound_revert_hours": "mehrere Stunden",
        "wallet_inbound_revert_seconds": "kurze Zeit",
        "wallet_status_faucet_credited": "+{amount} {symbol}",
    ...
    "pt": {
        **provider_base(),
        ...
        "wallet_login_language_label": "Idioma",
        "wallet_inbound_revert_days": "7 dias",
        "wallet_inbound_revert_hours": "várias horas",
        "wallet_inbound_revert_seconds": "pouco tempo",
        "wallet_status_faucet_credited": "+{amount} {symbol}",
    ...
    "ar": {
        **provider_base(),
        ...
        "wallet_inbound_revert_days": "7 ايام",
        "wallet_inbound_revert_hours": "عدة ساعات",
        "wallet_inbound_revert_seconds": "وقت قصير",
        "wallet_status_faucet_credited": "+{amount} {symbol}",
    ...
    "zh": {
        **provider_base(),
        ...
        "wallet_inbound_revert_days": "7天",
        "wallet_inbound_revert_hours": "数小时",
        "wallet_inbound_revert_seconds": "短时间",
        "wallet_status_faucet_credited": "+{amount} {symbol}",
    ...
    "hi": {
        **provider_base(),
        ...
        "wallet_inbound_revert_days": "7 दिन",
        "wallet_inbound_revert_hours": "数時間",
        "wallet_inbound_revert_seconds": "短時間",
        "wallet_status_faucet_credited": "+{amount} {symbol}",
    ...
    "ja": {
        **provider_base(),
        ...
        "wallet_inbound_revert_days": "7日間",
        "wallet_inbound_revert_hours": "数時間",
        "wallet_inbound_revert_seconds": "短時間",
        "wallet_status_faucet_credited": "+{amount} {symbol}",
        "wallet_faucet_label_percent": "確率パーセント分析",

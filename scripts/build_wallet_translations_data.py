...
PROVIDER: dict[str, dict[str, str]] = {
    ...
    "es": {
        **provider_base(),
        ...
        "wallet_receive_delay_12_months": "12 meses",
        "wallet_receive_delay_months": "varios meses",
        "wallet_receive_delay_hours": "varias horas",
        "wallet_receive_delay_seconds": "poco tiempo",
        "wallet_status_faucet_credited": "+{amount} {symbol}",
    ...
    "fr": {
        **provider_base(),
        ...
        "wallet_receive_delay_12_months": "12 mois",
        "wallet_receive_delay_months": "plusieurs mois",
        "wallet_receive_delay_hours": "plusieurs heures",
        "wallet_receive_delay_seconds": "un court délai",
        "wallet_status_faucet_credited": "+{amount} {symbol}",
    ...
    "de": {
        **provider_base(),
        ...
        "wallet_receive_delay_12_months": "12 Monate",
        "wallet_receive_delay_months": "mehrere Monate",
        "wallet_receive_delay_hours": "mehrere Stunden",
        "wallet_receive_delay_seconds": "kurze Zeit",
        "wallet_status_faucet_credited": "+{amount} {symbol}",
    ...
    "pt": {
        **provider_base(),
        ...
        "wallet_login_language_label": "Idioma",
        "wallet_receive_delay_12_months": "12 meses",
        "wallet_receive_delay_months": "vários meses",
        "wallet_receive_delay_hours": "várias horas",
        "wallet_receive_delay_seconds": "pouco tempo",
        "wallet_status_faucet_credited": "+{amount} {symbol}",
    ...
    "ar": {
        **provider_base(),
        ...
        "wallet_receive_delay_12_months": "12 شهرًا",
        "wallet_receive_delay_months": "عدة أشهر",
        "wallet_receive_delay_hours": "عدة ساعات",
        "wallet_receive_delay_seconds": "وقت قصير",
        "wallet_status_faucet_credited": "+{amount} {symbol}",
    ...
    "zh": {
        **provider_base(),
        ...
        "wallet_receive_delay_12_months": "12 个月",
        "wallet_receive_delay_months": "数月",
        "wallet_receive_delay_hours": "数小时",
        "wallet_receive_delay_seconds": "短时间",
        "wallet_status_faucet_credited": "+{amount} {symbol}",
    ...
    "hi": {
        **provider_base(),
        ...
        "wallet_receive_delay_12_months": "12 महीने",
        "wallet_receive_delay_months": "数か月",
        "wallet_receive_delay_hours": "数時間",
        "wallet_receive_delay_seconds": "短時間",
        "wallet_status_faucet_credited": "+{amount} {symbol}",
    ...
    "ja": {
        **provider_base(),
        ...
        "wallet_receive_delay_12_months": "12か月",
        "wallet_receive_delay_months": "数か月",
        "wallet_receive_delay_hours": "数時間",
        "wallet_receive_delay_seconds": "短時間",
        "wallet_status_faucet_credited": "+{amount} {symbol}",

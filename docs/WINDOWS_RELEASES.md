...
If the Mac already created `v4.2.1`, the same command attaches your files (omit `-Draft`). When every platform you are shipping is on the draft:
...
**4.1.11:** historical exception — use [`v4.1.11-bundle`](https://github.com/rgsneddon/evolve/releases/tag/v4.1.11-bundle). Current ship is **`v4.2.1`**.

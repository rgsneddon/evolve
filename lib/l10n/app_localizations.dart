...
final _en = {
  ...
  'wallet_tx_genesis': 'Genesis renewal (286M PERC)',
  'wallet_signed_in_as': 'Signed in as {user}',
  'wallet_logout': 'Sign out',
  'wallet_treasury_title': 'Treasury emission',
  'wallet_treasury_note':
      'Chain advances only when scenarios run. Treasury earns 1 PERC per elapsed second (first block: 1 PERC) until ~286M cap, then a new genesis block renews the cycle.',
  ...
  'wallet_explorer_genesis_renewal': 'Genesis renewal — cycle #{cycle} (286M PERC)',
...
final _es = {
  ...
  'wallet_tx_genesis': 'Renovación génesis (286M PERC)',
  'wallet_signed_in_as': 'Sesión: {user}',
  'wallet_logout': 'Cerrar sesión',
  'wallet_treasury_title': 'Emisión de tesorería',
  'wallet_treasury_note':
      'La cadena avanza solo al ejecutar escenarios. Tesorería gana 1 PERC por segundo transcurrido (primer bloque: 1 PERC) hasta ~286M; luego un nuevo bloque génesis renueva el ciclo.',
  ...
  'wallet_explorer_genesis_renewal': 'Renovación génesis — ciclo #{cycle} (286M PERC)',
